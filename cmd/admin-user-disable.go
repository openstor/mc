...
func checkAdminUserDisableSyntax(ctx context.Context, cmd *cli.Command) {
	args := cmd.Args()
	if args.Len() != 2 {
...
func mainAdminUserDisable(ctx context.Context, cmd *cli.Command) error {
	checkAdminUserDisableSyntax(ctx, cmd)
